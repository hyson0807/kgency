...
export default function CompanyChats() {
  const { chatRooms, loading } = useChatRooms<CompanyChatRoom>({ userType: 'company' });

  const renderChatRoom = ({ item }: { item: CompanyChatRoom }) => (
    <ChatRoomItem chatRoom={item} userType="company" />
  );
