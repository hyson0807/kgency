...
export const settingsTranslations: TranslationData = {
    ...
    'settings.interview_proposal_notification': {
        en: 'Interview Proposal Notification',
        ja: '面接提案通知',
        zh: '面试邀请通知',
        vi: 'Thông báo đề xuất phỏng vấn',
        hi: 'साक्षात्कार प्रस्ताव सूचना',
        si: 'සම්මුඛ පරීක්ෂණ යෝජනා දැනුම්දීම',
        ar: 'إشعار اقتراح المقابلة',
        tr: 'Görüşme Teklifi Bildirimi',
        my: 'အင်တာဗျူးအဆိုပြုချက် အကြောင်းကြားစာ',
        ky: 'Маектешүү сунушу билдирүүсү',
        ha: 'Sanarwar Shawara Hira',
        mn: 'Ярилцлагын санал мэдэгдэл'
    },
    'settings.interview_proposal_description': {
        en: 'Notifications when companies send interview proposals',
        ja: '企業から面接提案を受けた時の通知',
        zh: '公司发送面试邀请时的通知',
        vi: 'Thông báo khi công ty gửi đề xuất phỏng vấn',
        hi: 'जब कंपनियां साक्षात्कार प्रस्ताव भेजती हैं तो सूचनाएं',
        si: 'සමාගම් සම්මුඛ පරීක්ෂණ යෝජනා යවන විට දැනුම්දීම්',
        ar: 'الإشعارات عندما ترسل الشركات اقتراحات المقابلة',
        tr: 'Şirketler görüşme teklifleri gönderdiğinde bildirimler',
        my: 'ကုမ္ပဏီများက အင်တာဗျူးအဆိုပြုချက်များ ပေးပို့သောအခါ အကြောင်းကြားစာများ',
        ky: 'Компаниялар маектешүү сунуштарын жөнөткөндө билдирүүлөр',
        ha: 'Sanarwa lokacin da kamfanoni suka aika da shawarwarin hira',
        mn: 'Компаниуд ярилцлага санал илгээх үед мэдэгдэл'
    },
    'settings.job_posting_interview_notification': {
        en: 'Job Posting Interview Proposal Notification',
        ja: '求人面接提案通知',
        zh: '职位面试邀请通知',
        vi: 'Thông báo đề xuất phỏng vấn tin tuyển dụng',
        hi: 'नौकरी पोस्टिंग साक्षात्कार प्रस्ताव सूचना',
        si: 'රැකියා ප්‍රකාශන සම්මුඛ පරීක්ෂණ යෝජනා දැනුම්දීම',
        ar: 'إشعار اقتراح مقابلة الوظيفة',
        tr: 'İş İlanı Görüşme Teklifi Bildirimi',
        my: 'အလုပ်ကြေငြာ အင်တာဗျူးအဆိုပြုချက် အကြောင်းကြားစာ',
        ky: 'Жумуш жарыясындагы маектешүү сунушу билдирүүсү',
        ha: 'Sanarwar Shawara Hira na Tallan Aiki',
        mn: 'Ажлын зар ярилцлагын санал мэдэгдэл'
    },
    'settings.job_posting_interview_description': {
        en: 'Notifications when you receive interview proposals for job applications',
        ja: '応募した求人で面接提案を受けた時の通知',
        zh: '应聘职位收到面试邀请时的通知',  
        vi: 'Thông báo khi nhận được đề xuất phỏng vấn cho đơn ứng tuyển',
        hi: 'नौकरी आवेदनों के लिए साक्षात्कार प्रस्ताव प्राप्त करने पर सूचनाएं',
        si: 'රැකියා අයදුම්පත් සඳහා සම්මුඛ පරීක්ෂණ යෝජනා ලැබෙන විට දැනුම්දීම්',
        ar: 'الإشعارات عند تلقي اقتراحات المقابلة لطلبات العمل',
        tr: 'İş başvuruları için görüşme teklifleri aldığınızda bildirimler',
        my: 'အလုပ်လျှောက်လွှာများအတွက် အင်တာဗျူးအဆိုပြုချက်များ လက်ခံသောအခါ အကြောင်းကြားစာများ',
        ky: 'Жумушка арыз берүү үчүн маектешүү сунуштарын алганда билдирүүлөр',
        ha: 'Sanarwa lokacin da kuka karbi shawarwarin hira don aikace-aikacen aiki',
        mn: 'Ажлын өргөдөлд ярилцлагын санал хүлээн авах үед мэдэгдэл'
    },
    'settings.interview_cancellation_notification': {
        en: 'Interview Cancellation Notification',
        ja: '面接キャンセル通知',
        zh: '面试取消通知',
        vi: 'Thông báo hủy phỏng vấn',
        hi: 'साक्षात्कार रद्दीकरण सूचना',
        si: 'සම්මුඛ පරීක්ෂණ අවලංගු දැනුම්දීම',
        ar: 'إشعار إلغاء المقابلة',
        tr: 'Görüşme İptal Bildirimi',
        my: 'အင်တာဗျူးပယ်ဖျက်ခြင်း အကြောင်းကြားစာ',
        ky: 'Маектешүү жокко чыгаруу билдирүүсү',
        ha: 'Sanarwar Soke Hira',
        mn: 'Ярилцлага цуцлах мэдэгдэл'
    },
    'settings.interview_cancellation_description': {
        en: 'Notifications when interviews are cancelled',
        ja: '面接がキャンセルされた時の通知',
        zh: '面试被取消时的通知',
        vi: 'Thông báo khi phỏng vấn bị hủy',
        hi: 'जब साक्षात्कार रद्द हो जाते हैं तो सूचनाएं',
        si: 'සම්මුඛ පරීක්ෂණ අවලංගු වූ විට දැනුම්දීම්',
        ar: 'الإشعارات عند إلغاء المقابلات',
        tr: 'Görüşmeler iptal edildiğinde bildirimler',
        my: 'အင်တာဗျူးများ ပယ်ဖျက်သောအခါ အကြောင်းကြားစာများ',
        ky: 'Маектешүүлөр жокко чыгарылганда билдирүүлөр',
        ha: 'Sanarwa lokacin da aka soke hira',
        mn: 'Ярилцлага цуцлагдах үед мэдэгдэл'
    },
    'settings.instant_interview_cancellation_notification': {
        en: 'Instant Interview Cancellation Notification',
        ja: '即時面接キャンセル通知',
        zh: '即时面试取消通知',
        vi: 'Thông báo hủy phỏng vấn tức thì',
        hi: 'त्वरित साक्षात्कार रद्दीकरण सूचना',
        si: 'ක්ෂණික සම්මුඛ පරීක්ෂණ අවලංගු දැනුම්දීම',
        ar: 'إشعار إلغاء المقابلة الفورية',
        tr: 'Anında Görüşme İptal Bildirimi',
        my: 'ချက်ချင်းအင်တာဗျူးပယ်ဖျက်ခြင်း အကြောင်းကြားစာ',
        ky: 'Тез арада маектешүү жокко чыгаруу билдирүүсү',
        ha: 'Sanarwar Soke Hira nan take',
        mn: 'Шууд ярилцлага цуцлах мэдэгдэл'
    },
    'settings.instant_interview_cancellation_description': {
        en: 'Notifications when instant interviews are cancelled',
        ja: '即時面接がキャンセルされた時の通知',
        zh: '即时面试被取消时的通知',
        vi: 'Thông báo khi phỏng vấn tức thì bị hủy',
        hi: 'जब त्वरित साक्षात्कार रद्द हो जाते हैं तो सूचनाएं',
        si: 'ක්ෂණික සම්මුඛ පරීක්ෂණ අවලංගු වූ විට දැනුම්දීම්',
        ar: 'الإشعارات عند إلغاء المقابلات الفورية',
        tr: 'Anında görüşmeler iptal edildiğinde bildirimler',
        my: 'ချက်ချင်းအင်တာဗျူးများ ပယ်ဖျက်သောအခါ အကြောင်းကြားစာများ',
        ky: 'Тез арада маектешүүлөр жокко чыгарылганда билдирүүлөр',
        ha: 'Sanarwa lokacin da aka soke hira nan take',
        mn: 'Шууд ярилцлага цуцлагдах үед мэдэгдэл'
    },
    'settings.application_cancellation_notification': {
        en: 'Application Cancellation Notification',
        ja: '応募キャンセル通知',
        zh: '申请取消通知',
        vi: 'Thông báo hủy đơn ứng tuyển',
        hi: 'आवेदन रद्दीकरण सूचना',
        si: 'අයදුම්පත් අවලංගු දැනුම්දීම',
        ar: 'إشعار إلغاء الطلب',
        tr: 'Başvuru İptal Bildirimi',
        my: 'လျှောက်လွှာပယ်ဖျက်ခြင်း အကြောင်းကြားစာ',
        ky: 'Арыз жокко чыгаруу билдирүүсү',
        ha: 'Sanarwar Soke Aikace',
        mn: 'Өргөдөл цуцлах мэдэгдэл'
    },
    'settings.application_cancellation_description': {
        en: 'Notifications when regular applications are cancelled',
        ja: '一般応募がキャンセルされた時の通知',
        zh: '普通申请被取消时的通知',
        vi: 'Thông báo khi đơn ứng tuyển thông thường bị hủy',
        hi: 'जब नियमित आवेदन रद्द हो जाते हैं तो सूचनाएं',
        si: 'සාමාන්‍ය අයදුම්පත් අවලංගු වූ විට දැනුම්දීම්',
        ar: 'الإشعارات عند إلغاء الطلبات العادية',
        tr: 'Düzenli başvurular iptal edildiğinde bildirimler',
        my: 'ပုံမှန်လျှောက်လွှာများ ပယ်ဖျက်သောအခါ အကြောင်းကြားစာများ',
        ky: 'Кадимки арыздар жокко чыгарылганда билдирүүлөр',
        ha: 'Sanarwa lokacin da aka soke aikace-aikace na yau da kullun',
        mn: 'Энгийн өргөдөл цуцлагдах үед мэдэгдэл'
    },
    'settings.activate_job_posting': {
        en: 'Activate Job Posting',
        ja: '求職公告活性化',
        zh: '激活求职公告',
        vi: 'Kích hoạt tin tuyển dụng công việc',
        hi: 'नौकरी पोस्टिंग सक्रिय करें',
        si: 'රැකියා ප්‍රකාශනය සක්‍රිय කරන්න',
        ar: 'تفعيل إعلان الوظيفة',
        tr: 'İş İlanını Etkinleştir',
        my: 'အလုပ်ကြေငြာကို ဖွင့်ပါ',
        ky: 'Жумуш жарыясын иштетүү',
        ha: 'Kunna Tallan Aiki',
        mn: 'Ажлын зар идэвхжүүлэх'
    },
    'settings.language_change_error': {
        en: 'An error occurred while changing the language.',
        ja: '言語変更中にエラーが発生しました。',
        zh: '更改语言时出现错误。',
        vi: 'Đã xảy ra lỗi khi thay đổi ngôn ngữ.',
        hi: 'भाषा बदलते समय त्रुटि हुई।',
        si: 'භාෂාව වෙනස් කරන විට දෝෂයක් ඇති විය.',
        ar: 'حدث خطأ أثناء تغيير اللغة.',
        tr: 'Dil değiştirilirken hata oluştu.',
        my: 'ဘာသာစကားကို ပြောင်းလဲနေစဉ် အမှားတစ်ခု ဖြစ်ပေါ်ခဲ့သည်။',
        ky: 'Тилди өзгөртүү учурунда ката кетти.',
        ha: 'An sami kuskure yayin canza harshe.',
        mn: 'Хэл өөрчлөх явцад алдаа гарлаа.'
    },
    'settings.activation_failed': {
        en: 'Activation Failed',
        ja: '活性化失敗',
        zh: '激活失败',
        vi: 'Kích hoạt thất bại',
        hi: 'सक्रियकरण विफल',
        si: 'සක්‍රියකරණය අසාර්ථක',
        ar: 'فشل التفعيل',
        tr: 'Etkinleştirme Başarısız',
        my: 'ဖွင့်ခြင်း မအောင်မြင်ပါ',
        ky: 'Иштетүү ийгиликсиз болду',
        ha: 'Kunna Ya Gagara',
        mn: 'Идэвхжүүлэлт амжилтгүй'
    }
}